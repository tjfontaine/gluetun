...
func (u *Updater) GetServers(ctx context.Context, minServers int) (
	...
	for _, url := range map[string]string{
		"vyprvpn": "https://support.vyprvpn.com/hc/article_attachments/360052617332/Vypr_OpenVPN_20200320.zip",
		"giganews": "https://support.giganews.com/hc/article_attachments/360055216371/VyprVPN_OpenVPN_Conf.zip",
	} {
		...
		servers = append(servers, hts.toServersSlice()...)
